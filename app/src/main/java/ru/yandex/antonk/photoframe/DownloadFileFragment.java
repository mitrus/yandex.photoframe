...
public class DownloadFileFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
      ...
      /*  } else {
            workFragment.setTargetFragment(getActivity().getSupportFragmentManager()
                    .findFragmentByTag(SlideshowFragment.TAG_PREFIX + showId), 0);
        }*/
            ...
            new Thread(new Runnable() {
                ...
                public void run () {
                    ...
                    try {
                        ...
                        client.downloadFile(item.getFullPath(), result, DownloadFileRetainedFragment.this); // DownloadFileRetainedFragment.this);
                        downloadComplete();
